...
def add_slide_from_page(prs, page, page_image_path, page_width, page_height):
    ...
    if has_sub_parent:
        print(f"  [v2 BACKUP] Sub-parent detected! Adding original image backup layer...")
        ...
        try:
            ...
            print(f"  [v2 BACKUP] Added original image at back")
        except Exception as e:
            print(f"  [v2 BACKUP ERROR] Failed to add original image: {e}")
        ...
        try:
            ...
            print(f"  [v2 BACKUP] Added background overlay with color RGB({bg_color[0]},{bg_color[1]},{bg_color[2]})")
        except Exception as e:
            print(f"  [v2 BACKUP ERROR] Failed to add background overlay: {e}")
...
def main():
    ...
    final_output_path = os.path.join(final_output_dir, "webapp_test_output3.pptx")
